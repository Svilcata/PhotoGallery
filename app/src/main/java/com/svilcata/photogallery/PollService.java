...
/**
 * Created by Svilcata on 08-May-16.
 */
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION = "com.svilcata.android.photogallery.SHOW_NOTIFICATION";

    public static final String PERM_PRIVATE = "com.svilcata.android.photogallery.PRIVATE";
    ...
    private boolean isNetworkAvailableAndConnected() {
        ...
        boolean isNewtorkConnected = isNetworkAvailable && cm.getActiveNetworkInfo().isConnected();
        return isNewtorkConnected;
    }
}
