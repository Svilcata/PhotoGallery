...
/**
 * Created by Svilcata on 04-May-16.
 */
public class FlickrFetchr {

    private static final String TAG = "FlickrFetchr";
    private static final String API_KEY = "893ddca25130e5bdddfc476a8617c108";
    ...
    public void fetchItems() {
        try {
            String url = Uri.parse("https://api.flickr.com/services/rest/").buildUpon().appendQueryParameter("method", "flickr.photos.getRecent")
                    .appendQueryParameter("893ddca25130e5bdddfc476a8617c108", API_KEY).appendQueryParameter("format", "json")
